...
const circulation_constants_1 = require("../circulation/circulation.constants");
let EmailService = EmailService_1 = class EmailService {
    ...
    hasSmtpCredentials() {
        return Boolean(this.configService.get('SMTP_USER') &&
    ...
    async onModuleInit() {
        ...
        try {
            ...
            this.logger.error('SMTP transporter verification failed.', error instanceof Error ? error.stack : String(error));
        }
    }
    async sendOverdueEmail(to, name, bookTitle, dueDate, fine, overdueDays) {
        const formattedDueDate = new Date(dueDate).toLocaleDateString();
        const mailOptions = {
            from: `"IITB Digital Library" <${this.configService.get('SMTP_USER') || 'no-reply@iitb.ac.in'}>`,
            to,
            subject: `Overdue Notice: "${bookTitle}"`,
            text: `Dear ${name},

The book "${bookTitle}" was due on ${formattedDueDate}.
It is now overdue by ${overdueDays} day(s), and your current fine is ৳${fine} at ৳${circulation_constants_1.OVERDUE_FINE_PER_DAY}/day.
...
`,
        ...
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; padding: 20px; border: 1px solid #ddd; border-radius: 10px; background-color: #f9f9f9;">
          ...
          <table style="width: 100%; border-collapse: collapse; margin-top: 15px;">
            ...
            <tr>
              ...
              <td style="padding: 8px; border-bottom: 1px solid #ddd; color: #d9534f; font-weight: bold;">৳${fine} (৳${circulation_constants_1.OVERDUE_FINE_PER_DAY}/day)</td>
            </tr>
          </table>
      ...
      `,
        ...
        try {
            ...
            this.logger.error(`Failed to send overdue email to ${to}.`, error instanceof Error ? error.stack : String(error));
            return false;
        }
    }
};
